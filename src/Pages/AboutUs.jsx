...
const AboutUs = () => {
    ...
    return (
        <div className="my-14 mx-5">
            ...
            <div className="mt-12" data-aos="zoom-in-up" data-aos-duration="2000">
                <p className="md:text-xl text-justify">At Srs fitness, we believe that living a healthy and fulfilling life is a journey,
            ...
            <div className='mt-5'>
                ...
                <div className="flex flex-col-reverse md:flex-row gap-9 items-center mt-3">
                    ...
                    <div className='flex-1' data-aos="fade-up-left" data-aos-duration="2000">
                        <img src={doctorImg} alt="" className='lg:w-2/3 md:float-right' />
                    </div>
                </div>
            </div>
            <div className='mt-5'>
                ...
                <div className="md:flex flex-row-reverse gap-9 items-center md:mt-8">
                    <div className='md:text-xl flex-1 text-justify' data-aos="fade-down-left" data-aos-duration="2000">
                        At Srs fitness, we take a holistic approach to health and wellness. We understand that well-being
                        encompasses not only physical health but also mental, emotional, and spiritual aspects of your life.
                    ...
                    <div className='flex-1' data-aos="fade-up-right" data-aos-duration="2000">
                        <img src={approchImg} alt="" className='lg:w-2/3' />
                    </div>
                </div>
            </div>
        </div>
