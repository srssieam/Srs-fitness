...
const AboutUs = () => {
    return (
        <div className="my-14 mx-5">
            <h1 className="mb-16 text-5xl text-center font-bold">About us</h1>
            <div className="bg-gray-800 flex flex-col gap-8 md:flex-row justify-around text-cyan-400 font-semibold text-xl w-3/5 p-7 mx-auto rounded-3xl shadow-xl shadow-cyan-400">
